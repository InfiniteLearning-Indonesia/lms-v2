    ...
    <div className="w-full max-w-sm">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1.5 text-sm text-muted-foreground">
          Portal login untuk siswa Infinite Learning.
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="mt-8 pt-6 border-t border-border text-center">
          <p className="text-xs text-muted-foreground">
            ...
            >
              Masuk di portal staf
            </Link>
          </p>
          <p className="text-xs text-muted-foreground">
            Pastikan kamu sudah cek email kamu dan terima undangan sebelum login!
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-brand-purple to-brand-gradient-end text-white p-12">
        ...
        <div className="max-w-sm">
          ...
          <p className="mt-4 text-white/60 text-sm leading-relaxed">
            Platform ini dirancang khusus untuk siswa Infinite Learning.
